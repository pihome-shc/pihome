...
select zone.status, zone.zone_status, zone.sync, zone.id, zone.index_id, zone.name, zone.type, ztype.category, zone.graph_it, zone.max_c, zone.max_operation_time, zone.hysteresis_time,
