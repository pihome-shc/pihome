...
CREATE TABLE IF NOT EXISTS `piconnect_logs` (
  ...
  `picurl` char(200) CHARACTER SET utf16_bin DEFAULT NULL,
  `content_type` char(200) CHARACTER SET utf16_bin DEFAULT NULL,
  `http_code` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `header_size` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `request_size` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `filetime` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `ssl_verify_result` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `redirect_count` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `total_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `connect_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `pretransfer_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `size_upload` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `size_download` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `speed_download` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `speed_upload` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `download_content_length` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `upload_content_length` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `starttransfer_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `primary_port` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `local_port` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `start_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `end_time` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `n_tables` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
  `records` char(50) CHARACTER SET utf16_bin DEFAULT NULL,
