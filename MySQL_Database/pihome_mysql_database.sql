...
REPLACE INTO `away` (`id`, `sync`, `status`, `start_datetime`, `end_datetime`, `away_button_id`, `away_button_child_id`) VALUES
	(1, 0, 0, '2017-10-30 15:27:17', NULL, 40, 4);
...
REPLACE INTO `boiler` (`id`, `sync`, `status`, `fired_status`, `name`, `node_id`, `node_child_id`, `hysteresis_time`, `max_operation_time`, `datetime`, `gpio_pin`) VALUES
	(1, 0, 1, 1, 'Gas Boiler', 5, 1, 3, 60, '2017-11-03 00:49:02', NULL);
...
REPLACE INTO `boost` (`id`, `sync`, `status`, `zone_id`, `time`, `temperature`, `minute`, `boost_button_id`, `boost_button_child_id`) VALUES
	(8, 0, 0, 33, '2017-10-07 00:17:02', 23, 30, 40, 1),
	(9, 0, 0, 34, '2017-10-16 13:12:27', 23, 30, 40, 2),
	(10, 0, 0, 35, '2017-10-30 13:46:02', 35, 30, 40, 3);
...
REPLACE INTO `frost_protection` (`id`, `sync`, `datetime`, `temperature`) VALUES
	(1, 0, '2017-06-16 15:55:48', -1);
...
REPLACE INTO `gateway` (`id`, `sync`, `type`, `location`, `port`, `timout`) VALUES
	(1, 0, 'wifi', '192.168.99.3', '5003', '3');
...
REPLACE INTO `messages_out` (`id`, `sync`, `node_id`, `child_id`, `sub_type`, `ack`, `type`, `payload`, `sent`, `datetime`, `zone_id`) VALUES
	(15, 0, '101', 1, 1, 1, 2, '1', 1, '2017-11-03 00:51:02', 33),
	(17, 0, '101', 2, 1, 1, 2, '1', 1, '2017-11-03 00:51:03', 34),
	(19, 0, '101', 3, 1, 1, 2, '1', 1, '2017-11-03 00:51:04', 35),
	(21, 0, '40', 1, 1, 1, 2, '1', 1, '2017-10-06 13:22:14', 33),
	(22, 0, '40', 2, 1, 1, 2, '0', 1, '2017-10-06 13:12:10', 34),
	(23, 0, '40', 3, 1, 1, 2, '1', 1, '2017-10-06 13:20:59', 35),
	(24, 0, '100', 1, 1, 1, 2, '1', 1, '2017-11-03 00:51:05', 0);
...
REPLACE INTO `nodes` (`id`, `sync`, `node_id`, `child_id_1`, `child_id_2`, `child_id_3`, `child_id_4`, `child_id_5`, `child_id_6`, `child_id_7`, `child_id_8`, `name`, `last_seen`, `status`, `ms_version`, `sketch_version`) VALUES
	(1, 0, '21', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Temperature Sensor', '2017-11-02 22:47:34', 'Active', '2.1.1', '1.34'),
	(2, 0, '20', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Temperature Sensor', '2017-11-02 22:43:29', 'Active', '2.1.1', '1.34'),
	(4, 0, '30', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Temperature Sensor', '2017-11-02 22:50:51', 'Active', '2.1.1', '1.34'),
	(5, 0, '100', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Boiler Relay', '2017-09-11 17:01:54', 'Active', NULL, NULL),
	(6, 0, '25', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Temperature Sensor', '2017-11-02 22:49:08', '000', '2.1.1', '1.34'),
	(7, 0, '0', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Button Console', '2018-04-08 22:12:13', 'Active', '2.1.1', NULL),
	(112, 0, '101', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Zone Controller Relay', '2017-10-30 15:45:06', NULL, '2.1.1', '1.2'),
	(113, 0, '0', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Zone Controller Relay', '2017-10-30 15:45:06', NULL, '2.1.1', '1.2'),
	(116, 0, '40', 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Button Console', '2017-10-06 13:09:31', NULL, '2.1.1', '1.31');
...
REPLACE INTO `override` (`id`, `sync`, `status`, `zone_id`, `time`, `temperature`) VALUES
	(8, 0, 0, 33, '2017-09-22 12:00:18', 24),
	(9, 0, 0, 34, '2017-09-22 12:00:19', 24),
	(10, 0, 0, 35, '2017-07-14 16:35:55', 35);
...
REPLACE INTO `schedule_daily_time` (`id`, `sync`, `status`, `start`, `end`) VALUES
	(59, 0, 1, '15:00:00', '15:30:00'),
	(60, 0, 1, '18:00:00', '18:30:00'),
	(61, 0, 1, '19:00:00', '19:45:00'),
	(64, 0, 1, '16:00:00', '16:45:00'),
	(65, 0, 1, '09:00:00', '09:30:00'),
	(66, 0, 1, '11:00:00', '11:20:00'),
	(67, 0, 1, '12:00:00', '12:30:00'),
	(68, 0, 1, '14:00:00', '14:30:00'),
	(69, 0, 1, '17:00:00', '17:45:00'),
	(70, 0, 1, '08:00:00', '08:20:00'),
	(71, 0, 1, '10:00:00', '10:20:00'),
	(72, 0, 1, '13:00:00', '13:30:00'),
	(73, 0, 1, '07:00:00', '07:30:00');
...
REPLACE INTO `schedule_daily_time_zone` (`id`, `sync`, `status`, `schedule_daily_time_id`, `zone_id`, `temperature`) VALUES
	(120, 0, 1, 59, 33, 21),
	(121, 0, 0, 59, 34, 0),
	(122, 0, 1, 59, 35, 26),
	(123, 0, 1, 60, 33, 21),
...
REPLACE INTO `schedule_night_climate_time` (`id`, `sync`, `status`, `start_time`, `end_time`) VALUES
	(1, 0, 1, '21:00:00', '06:00:00');
...
REPLACE INTO `schedule_night_climat_zone` (`id`, `sync`, `status`, `zone_id`, `schedule_night_climate_id`, `min_temperature`, `max_temperature`) VALUES
	(8, 0, 0, 33, 1, 18, 21),
	(9, 0, 1, 34, 1, 18, 21),
	(10, 0, 0, 35, 1, 18, 21);
...
REPLACE INTO `system` (`id`, `sync`, `name`, `version`, `build`, `update_location`, `update_file`, `update_alias`, `country`, `city`, `openweather_api`, `backup_email`, `ping_home`, `pi_serial`, `timezone`) VALUES
	(2, 0, 'PiHome - Smart Heating Control', '0.24', '280318', 'http://www.pihome.eu/updates/', 'current-release-versions.php', 'pihome', 'IE', 'Portlaoise', '', 'info@pihome.eu', b'1', '1', 'Europe/Dublin');
...
REPLACE INTO `weather` (`id`, `sync`, `location`, `c`, `wind_speed`, `title`, `description`, `sunrise`, `sunset`, `img`, `last_update`) VALUES
	(1, 0, 'Portlaoise', 9, '4.18', 'Clouds', 'broken clouds', '1509694256', '1509728026', '04n', '2017-11-03 00:30:02');
...
REPLACE INTO `zone` (`id`, `sync`, `status`, `index_id`, `name`, `type`, `model`, `max_c`, `max_operation_time`, `hysteresis_time`, `sensor_id`, `sensor_child_id`, `controler_id`, `controler_child_id`, `boiler_id`, `gpio_pin`) VALUES
	(33, 0, 1, 1, 'Ground Floor', 'Heating', NULL, 23, 60, 3, 1, 0, 112, 1, 1, NULL),
	(34, 0, 1, 2, 'First Floor', 'Heating', NULL, 23, 60, 3, 2, 0, 112, 2, 1, NULL),
	(35, 0, 1, 5, 'Ch. Hot Water', 'Water', NULL, 50, 60, 3, 4, 0, 112, 3, 1, NULL);
