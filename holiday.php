...
if (isset($_POST['submit'])) {
		...
		$query = "INSERT INTO holidays(id, sync, status, start_date_time, end_date_time) VALUES ('{$id}', '0', '{$holidays_enable}', '{$start_date_time}','{$end_date_time}') ON DUPLICATE KEY UPDATE sync = VALUES(sync), status = VALUES(status), start_date_time = VALUES(start_date_time), end_date_time = VALUES(end_date_time);";
