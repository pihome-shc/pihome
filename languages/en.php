...
$lang['zone_controller_id_error'] = "Zone Controller ID can not be empty! Select the Node connect to the Zone's motorized valve, If your zone is connected to RPI GPIO you can select 0.";
...
$lang['pihome_backup_text'] = "Full database backup will takes quite a while to complete. Backup will be sent to the below email address.";
