...
void WiFiManager::handleRoot() {
  ...
  page += String(F("<h2>PiHome Smart Heating</h2>"));
//  page += String(F("<h1>"));
//  page += _apName;
//  page += String(F("</h1>"));
  page += String(F("<h5>Configure Smart Home Gateway WiFi Setting</h5>"));
...
void WiFiManager::handleReset() {
  ...
  page += _customHeadElement;
  page += FPSTR(HTTP_HEADER_END);
  page += F("PiHome Smart Home Gateway will restart in a few seconds.");
  page += FPSTR(HTTP_END);
