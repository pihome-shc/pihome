...
//PiHome Node ID If you are following PiHome project then leave this ID 100 for Boiler otherwise you have to make changes in MySQL Database. 
...
void presentation()
{
	...
	sendSketchInfo("Boiler Relay", "1.2");
